...
- **`Session.refreshTokenHash` stores a SHA-256 hash, never the raw token.** See [Phase 3 auth design](../PROJECT_PLAN.md) — a database read alone can't be replayed as a live session.
